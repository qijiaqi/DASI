 ...
 * @author ysabatierm
 */
public class InterventionsEnCoursSerialisation extends Serialisation{
    @Override
    public void appliquer(HttpServletRequest request, HttpServletResponse response) throws IOException {
        Client c = (Client) request.getAttribute("client");
        List<Intervention> histo = Service.interventionsEnCours(c);
        ...
        container.add("interventionsEnCours",jsonHistorique);
